    ...
    <div className="min-h-screen grid md:grid-cols-2 bg-background">
      <div className="hidden md:flex flex-col justify-between p-10 bg-gradient-hero text-primary-foreground relative overflow-hidden">
        ...
        <div className="relative max-w-md">
          <h2 className="font-display text-5xl leading-[1.05]">Run your tent house like a studio.</h2>
          <p className="mt-6 text-primary-foreground/80 text-lg">
            Bookings, inventory, payments, vendors and analytics — designed for the way Indian rental businesses actually work.
          </p>
        </div>
